...
export default function FeedPage() {
  ...
  async function reactPost(postId, emoji) {
    await API(`/posts/${postId}/react`, { method:'POST', body: JSON.stringify({ emoji }) });
  }
  ...
  async function reactComment(postId, commentId, emoji) {
    await API(`/posts/${postId}/comment/${commentId}/react`, { method:'POST', body: JSON.stringify({ emoji }) });
  }
